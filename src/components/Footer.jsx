				...
				<div className="container-fluid">
					<div className="row text-muted">
						<div className="col-6 text-start">
							<p className="mb-0">
								<a className="text-muted" href="http://localhost:3000/layout/main" target="_blank"><strong>Sabzi Khata</strong></a> - <a className="text-muted" href="https://adminkit.io/" target="_blank"><strong>Admin Site</strong></a>								&copy;
							</p>
						</div>
