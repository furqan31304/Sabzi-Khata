...
import { supplierGet } from '../../Redux/supplier/action';
import Select from 'react-select'
import { supplierSet, productGetActive } from '../../Redux/posSupplier/action';
...
const CustomerCard1 = () => {
  ...
  console.log("Product item:asdasdasdas:....",activeProducts)
    ...
    const customer_data=useSelector((state)=>state.supplierReducer.supplier_get.data)
    ...
    const handleSelectChange=(selectedOption)=>{
      ...
      dispatch(supplierSet(selectedOption))
    }
