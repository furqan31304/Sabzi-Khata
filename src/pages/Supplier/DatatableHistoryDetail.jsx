...
function DatatableHistoryDetail() {
  const history_detail=useSelector((state)=>state.supplierReducer.supplier_history_details.data)
  const loading=useSelector((state)=>state.supplierReducer.supplier_history_details.loading)
  ...
  <div className="modal-dialog  modal-xl modal-dialog-centered">
    <div className="modal-content ">
      <div className="modal-header">
        <h5 className="modal-title" id="exampleModalToggleLabel">Edit Supplier Details</h5>
