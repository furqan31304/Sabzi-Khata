...
import { customerHistory, customerHistoryDetails } from '../../Redux/customer/action';
...
function DatatableHistory() {
  ...
  const cus_history=useSelector((state)=>state.customerReducer.customer_history.data)
  const loading=useSelector((state)=>state.customerReducer.customer_history.loading)
  ...
  // }, [cus_history])
    ...
    const columns = [
        ...
        {
            name: 'Action',
            selector: row => <button   className="btn btn-outline-success" data-bs-toggle="modal" href="#exampleModalToggle" type='button'onClick={()=>dispatch(customerHistoryDetails({admin_id:admin_id,customer_id:row.customer_id,sale_id:row.sale_id}))}>View</button>,
          width:"auto"
