...
<div className='row'>
      ...
      <div className="row my-2">
            ...
            <div className="col">{userData?.customer_id}</div>
        </div>
        <div>
            <hr />
        </div>
        ...
        <div className="row my-2">
            ...
            <div className="col">{userData?.adress}</div>
        </div>
      </div>
    </div>
      ...
      <div className='col-sm bg-white pt-3 col-lg-9 col-xl-11 col-md-9 col-sm' style={{borderRadius:"15px"}}>
        <div className='col d-flex m-1 '>
          ...
          <div className="row">
      <div className='col mx-2'>
      <DatatableHistory customer_id={userData?.customer_id}/>
      </div>
    </div>
